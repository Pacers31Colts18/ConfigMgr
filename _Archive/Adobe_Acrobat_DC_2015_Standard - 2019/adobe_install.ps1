...
$LogFile = "C:\InstallLogs\Error-Adobe-AcrobatStandard.log"

$Acrobat = Get-Process -Name Acrobat -ErrorAction SilentlyContinue
$Acrord32 = Get-Process -Name AcroRd32 -ErrorAction SilentlyContinue
