...
$Logfile = "C:\InstallLogs\Java Error.log"

$Process = Get-Process -Name iexplore -ErrorAction SilentlyContinue

#New Version Variables - Java8u211
$Java32 = 'HKLM:\Software\Microsoft\Windows\CurrentVersion\Uninstall\{26A24AE4-039D-4CA4-87B4-2F32180211F0}'
$Java64 = 'HKLM:\Software\Microsoft\Windows\CurrentVersion\Uninstall\{26A24AE4-039D-4CA4-87B4-2F64180211F0}'
...
#Install Arguments
$Switches32 = "AgreeToLicense=YES IEXPLORER=1 MOZILLA=1 REBOOT=SUPRESS JAVAUPDATE=0 STATIC=1 /qn /L C:\InstallLogs\Java32.log"
$Switches64 = "AgreeToLicense=YES IEXPLORER=1 MOZILLA=1 REBOOT=SUPRESS JAVAUPDATE=0 STATIC=1 /qn /L C:\InstallLogs\Java64.log"


#Install 32 bit Java, update to new filename
Start-Process -FilePath "msiexec" -ArgumentList "/i jre1.8.0_211.msi $Switches32" -Wait

#Install 64 bit Java, update to new filename
Start-Process -FilePath "msiexec" -ArgumentList "/i jre1.8.0_21164.msi $Switches64" -Wait
}